...
{               ?>
		 ...
		 <div class="latest">
			 ...
			 <div class="pic start">
				 ...
				 <h4><a href="event.html">DJ DARSH</a></h4>
				 <p>The job of feets is walking, but their hobby is dancing.</p>
			 </div>
			 <div class="pic">
				 ...
				 <h4><a href="event.html">DJ SHAMELESS</a></h4>
				 <p>It was always a dream for me as a kid to become the No 1 DJ in the world.</p>
			 </div>
			 <div class="pic">
				 ...
				 <h4><a href="event.html">DJ NICK</a></h4>
				 <p>A truly great DJ, just for a moment, can make a whole room fall in love.</p>
			 </div>
			 <div class="pic">
				 ...
				 <h4><a href="event.html">DJ MAZA</a></h4>
				 <p>My job as a DJ and a producer is just to have a big encyclopedia in my head.</p>
			 </div>
			 <div class="pic">
				 ...
				 <h4><a href="event.html">DJ SCREW</a></h4>
				 <p>I'm a DJ who makes dance music who got to play with Sting.</p>
			 </div>
			 <div class="clearfix"></div>
		 </div>
