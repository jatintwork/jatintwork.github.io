		  ...
		  <div class="slider">
			...
			<ul class="rslides" id="slider">
			  <li><img src="images/7.jpg" alt="">
				<div class="caption">
					<h1>Image1</h1>
					<p>Life is short. Make your next party epic. ❤️‼️</p>
				</div>
			  </li>
			  <li><img src="images/2.jpg" alt="">
				<div class="caption">
					<h1>Image2</h1>	  
					<p>It’s not about what we hear, but what we feel.</p>
				</div>
			  </li>	      
			  <li><img src="images/10.jpg" alt="">
				<div class="caption">
					<h1>Image3</h1>	  
					<p>There are some beats that move the soul, and some that move the feet. Only real artists can tell the difference.
</p>
				</div>
			  </li>
			  <li><img src="images/5.jpg" alt="">
				<div class="caption">
					<h1>Image1</h1>
					<p>Lighting for the dance floor to perfectly compliment your night’s soundtrack.</p>
				</div>
			  </li>
			  <li><img src="images/8.jpg" alt="">
				<div class="caption">
					<h1>Image2</h1>	  
					<p>Never trust a DJ who can’t dance. </p>
				</div>
			  </li>	      
			  <li><img src="images/1.jpg" alt="">
				<div class="caption">
					<h1>Image3</h1>	  
					<p>Don't put things off till it's too late. You are the DJ of your fate.</p>
				</div>
			  </li>
			  <li><img src="images/13.jpg" alt="">
				<div class="caption">
					<h1>Image2</h1>	  
					<p>Bringing the club vibe to you, at home.</p>
				</div>
			  </li>	      
			  <li><img src="images/3.jpg" alt="">
				<div class="caption">
					<h1>Image3</h1>	  
					<p>Be you, do you, and love you.</p>
				</div>
			  </li>
			</ul>
