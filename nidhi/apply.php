...
<body>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <h1 class="display-3 mb-4 animated slideInDown">Apply Now</h1>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        ...
                        <label for="exp">Your Address</label>
                    </div>
                </div>

                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="postt" name="postt" placeholder="Your Profession"
                            required />
                        <label for="postt">Your Profession</label>
                    </div>
                </div>

                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="number" class="form-control" id="address" name="address" placeholder="Your Address"
                            required />
                        <label for="address">Your Monthly Salary</label>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="number" class="form-control" id="postt" name="postt" placeholder="Desired Post"
                            required />
                        <label for="postt">Loan Amount</label>
                    </div>
                </div>
                <div class="col-md-6" style="color: blue;">
                    <div class="form-floating">
                        <select name="loan_type" id="loan_type" class="form-control" style="color: red;" required>

                            <option value="">Select Your Loan Type</option>
                            <!-- <option value="select" >Select Your Loan Type</option> -->
